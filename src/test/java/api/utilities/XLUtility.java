...
public class XLUtility {
	...
	public void fillGreenColor(String sheetName, int rownum, int colnum) throws Throwable {
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
		row = sheet.getRow(rownum);
	...
	public void fillRedColor(String sheetName, int rownum, int colnum) throws Throwable {
		fi = new FileInputStream(path);
		workbook = new XSSFWorkbook(fi);
		sheet = workbook.getSheet(sheetName);
		row = sheet.getRow(rownum);
